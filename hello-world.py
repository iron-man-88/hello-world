...
variable_output = st.sidebar.text_area("Enter some text", value="286Streamlit is awesome<br>aaa")
...
st_copy_to_clipboard("Copy this to clipboard", help='<span style="color:blue"></span>')
