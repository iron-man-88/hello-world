...
<div data-tooltip="Kampf" class="div_inner"<div class="div_outer" "qqq">{variable_output}></div>
"""
###<div data-tooltip="Kampf" class="div_inner" <div class="div_outer">{variable_output}</div></div>
